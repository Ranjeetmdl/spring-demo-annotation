...
public class MyCustomBeanProcessor implements BeanFactoryAware, BeanPostProcessor, DisposableBean {
	...
	List<Object> prototypeBeans = new ArrayList<Object>();
	...
	@Override
	public void setBeanFactory(BeanFactory theBeanFactory) throws BeansException {
		beanFactory = theBeanFactory;
	}

	@Override
	public void destroy() throws Exception {
		// loop through the prototype beans and call the destroy() method on
		// each one
		synchronized (prototypeBeans) {
